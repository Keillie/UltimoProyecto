...
package proyecto;    //NOTA verificar getter and setter de variables 
...
public class Atributo {
    ...
    public void setNombre(String nombre) {
        ...
        for (int i = 0; i < nombre.length(); i++) { //convertir caracter por caracter a byte y agregarlo al arreglo
    ...
    public void setRequiereLongitud(boolean requiereLongitud) { //Revisar
